...
;76=(OoDep);80=(OoDesA);84=(OoDesD);88=(OoGua);92=(OoTraA);94=(OoTraD2);98=(OoTraD);101=(OoExTraD);102=(OoExTraA);121=(OoIncReg);141=(OoTraD3);142=(OoTraD4);143=(OoTraD5);144=(OoTraD6);145=(OoExTraD2);181=(Trader at Destination);182=(Holder of the transit procedure);183=(OoGua2)
</xsl:variable>
...
<xsl:template match="/">
	...
	<testcase xmlns="http://jazz.net/xmlns/alm/qm/v0.1/">
		...
		<category term="Projekt" value="NCTS-5"/>
		...
		<xsl:text>CD Protocol:     |  Simulated Period:      |  </xsl:text>
		...
		<br/>
		<xsl:text>Holder of the transit procedure:</xsl:text>
		<br/>
		...
		<xsl:text>Prelodged Declaration :</xsl:text>		
		<br/>
		<xsl:text>Vereinfachtes Verfahren :</xsl:text>
		<br/>
		<xsl:text>Timers :</xsl:text>
		</xsl:if>		
		</com.ibm.rqm.planning.editor.section.testCaseDesign>
	</testcase>
	</xsl:template>
